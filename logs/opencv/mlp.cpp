...
int main(int argc, char* argv[]) {
   ...
   for (int i = 0; i!=folds; i++){
        ...
        // train
        mlp.train(values, responses, cv::Mat(), training, params);      // Esta se usa cuando estamos usando cross-validation
        //mlp.train(values, responses, cv::Mat(), cv::Mat(), params);   // Esta se usa cuando queremos generar la red final para probar los de control
